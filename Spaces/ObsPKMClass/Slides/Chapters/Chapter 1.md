...
- Notebooks <!-- element class="fragment"  -->
- Folders and cabinets <!-- element class="fragment" -->
- Index Cards <!-- element class="fragment" -->
- PDAs <!-- element class="fragment" -->
...
__And...__ <!-- element class="fragment"  style="color:red;"-->

In practice, the more extensive your notes the less accessible any piece of information is! <!-- element class="fragment" -->
...
### Gather
#### Two main kinds of information <!-- element class="fragment" style="margin-top: 1em;"  -->
...
2. Collect all of your information on any given topic <!-- element class="fragment" -->
...
::: block <!-- element class="fragment fade-in-then-out" style="margin-top: -6em" --> 
And most important:
:::
...
### Getting started  <!-- element style="margin-bottom: 0em;" -->


<video data-autoplay controls width="800" height="600"><source src="Spaces/ObsPKMClass/Resources/Install and First Note.mp4" type="video/mp4"></video> <!-- element style="margin-top: 0em;" -->
